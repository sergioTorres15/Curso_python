...
class Deck:
    suits = ["diamons","heart","spades","clubs"]
    max_number = 13
    def __init__(self):
        self.cards = []
...
class Game:
    ...
    def ask_player_name(self,player_n):
        return input("{} - what is your Nickname? : ".format(player_n))
    ...
    def player_wants_to_continue(self):
        response = input("Do you want another letter?? [YES / NOT] : ")
        return response == "yes"
